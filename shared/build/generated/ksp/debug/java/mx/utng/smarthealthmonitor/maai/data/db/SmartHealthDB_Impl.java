package mx.utng.smarthealthmonitor.maai.data.db;
    ...
    final SupportSQLiteOpenHelper.Callback _openCallback = new RoomOpenHelper(config, new RoomOpenHelper.Delegate(1) {
      ...
      public RoomOpenHelper.ValidationResult onValidateSchema(
        ...
        if (!_infoLecturasFc.equals(_existingLecturasFc)) {
          return new RoomOpenHelper.ValidationResult(false, "lecturas_fc(mx.utng.smarthealthmonitor.maai.data.db.LecturaFC).\n"
                  + " Expected:\n" + _infoLecturasFc + "\n"
                  + " Found:\n" + _existingLecturasFc);
        }
